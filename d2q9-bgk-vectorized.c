...
float av_velocity(const t_param params, t_speed_new* cells, int* obstacles, int tot_cells);

/* calculate Reynolds number */
float calc_reynolds(const t_param params, t_speed_new* cells, int* obstacles, int tot_cells);
